...
<html lang="en">
  ...
  <!-- wellcome Section  -->
  <section id="wellcome" class="Welcome">
  ...
  <div class="container mt-5"> <!-- Start All Course -->
      <h1 class="text-center Allcourses" style="font-size: 40px;">All Courses</h1>
      <div class="row mt-4" style="width: 1029px;"> <!-- Start All Course Row -->
      <?php
            ...
            while($row = $result->fetch_assoc()){
              ...
              echo ' 
                <div class="col-sm-4 mb-4">
                  <a href="coursedetails.php?course_id='.$course_id.'" class="btn" style="text-align: left; padding:0px;"><div class="card" style="width: 300px;">
                    ...
                    <div class="card-footer">
                      <p class="card-text d-inline">Price: <small><del>&#8377 '.$row['course_original_price'].'</del></small> <span class="font-weight-bolder">&#8377 '.$row['course_price'].'<span></p> <a class="btn btn-primary text-white font-weight-bolder float-right" style="height: 27px; width: 65px; border-radius:10px; background-color: #193063; font-size: 12px;" href="coursedetails.php?course_id='.$course_id.'">Enroll</a>
                    </div>
                  </div> </a>
                </div>
              ';
