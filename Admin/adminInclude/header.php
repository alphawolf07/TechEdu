...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top p-0 shadow" style="background-color: #225470;">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="adminDashboard.php">TechEdu <small class="text-white">Admin Area</small></a> 
 </nav>
 ...
 <div class="container-fluid mb-5" style="margin-top:40px;">
  <div class="row">
   <nav class="col-sm-3 col-md-2 bg-light sidebar py-5 d-print-none" style="">
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'Internships') {echo 'active';} ?>" href="Internship.php">
        <i class="fab fa-accessible-icon"></i>
        Internships
       </a>
      </li>
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'UpcomingEvents') {echo 'active';} ?>" href="Upcomingevents.php">
        <i class="fab fa-accessible-icon"></i>
        Upcoming Events
       </a>
      </li>
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'PreviousEvents') {echo 'active';} ?>" href="Previousevents.php">
        <i class="fab fa-accessible-icon"></i>
        Previous Events
       </a>
      </li>
