...
include('../dbConnection.php');
 ...
 if(isset($_REQUEST['requpdate'])){
  ...
  if(($_REQUEST['Internship_id'] == "") || ($_REQUEST['_name'] == "") || ($_REQUEST['course_desc'] == "") || ($_REQUEST['course_author'] == "") || ($_REQUEST['course_duration'] == "") || ($_REQUEST['course_price'] == "") || ($_REQUEST['course_original_price'] == "")){
