...
?>  
   <div class="container" style="position:absolute; top:100px; left: 50px;">
     <h2 class="text-center my-4" style=" position: absolute; left:220px; ">Payment Status </h2>
     <form method="post" action="">
     <div class="form-group row" style="position:absolute; top:100px; left:-50px">
