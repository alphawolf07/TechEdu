...
<body>
   ...
   <div class="container-fluid bg p-2" style="margin-bottom: 8px; background-color: #225470; z-index: 10;">
    ...
    <a class="btn btn-danger" href="./myCourse.php" style="position: absolute; right: 30px; top: 10px;">My Courses</a>
   </div>
   
   <div class="container-fluid">
    <div class="row" style="height: 800px;">
     <div class="col-sm-3 border-right" style="background: #c6d7f7;">
       <a href="" style="text-decoration: none; color: #fff;"><h4 class="text-center">Lessons</h4></a>
             ...
             if(isset($_GET['course_id'])){
              ...
              if($result->num_rows > 0){
               while($row = $result->fetch_assoc()){
                echo '<li class="nav-item border-bottom py-2 head" movieurl='.$row['lesson_link'].' style="cursor: pointer; padding-left:0.5rem;">'. $row['lesson_name'] .'</li>';
               }
              }
             }
          ?>
