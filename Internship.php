...
<div class="container mt-5"> <!-- Start All Course -->
      <h1 class="text-center Allcourses" style="font-size: 40px;">Internships</h1>
            ...
            while($row = $result->fetch_assoc()){
              ...
              echo ' 
                <div class="col-sm-4 mb-4">
                  <a href="Google_form_link?Internship_id='.$Internship_ID.'" class="btn" style="text-align: left; padding:0px;"><div class="card" style="width: 300px;">
                    <img src="'.str_replace('..', '.', $row['Internship_img']).'" class="card-img-top" alt="insert an image" />
                    <div class="card-body">
